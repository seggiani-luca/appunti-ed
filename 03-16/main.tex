...
\end{center}
Questo tipo di rettifica viene detta \textit{single phase rectification}, in quanto l'onda sotto lo 0 di potenziale viene "troncata" completamente.
...
\begin{enumerate}
\item Innanzitutto, quando entra in conduzione, il diodo presenta una caduta di potenziale $V_\gamma$ (che modellizziamo con un generatore di tensione):
