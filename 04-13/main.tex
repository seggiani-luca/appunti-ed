...
Assumendo $h_{re} = 0$ e $h_{oe} = 0$ e facendo l'analisi del circuito in AC, si ottiene il seguente circuito:
...
In questo caso gli elettroni liberi del substrato, che ricordiamo sono dati dalla legge di mass azione:
$$
n = \frac{n_i^2}{p}
$$
