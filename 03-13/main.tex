...
\begin{itemize}
	\item I diodi che stanno fra $0$ e $5$ volts di tensione di breakdown $V_{BR}$ presentano principalmente l'effetto \textit{Zener};
	\item I diodi che stanno fra $7$ e $+\infty$ volts di tensione di breakdown $V_{BR}$ presentano principalmente l'effetto \textit{valanga};
