...
Nel caso ci fossero dubbi riguardo a come mai prendiamo $ - \frac{e \vec{E}}{m} \tau = a \tau$ anziché $ - \frac{1}{2} \frac{e \vec{E}}{m} \tau = \frac{1}{2} a \tau$ per la velocità di deriva media, che è ciò che ci aspetteremmo da un andamento della velocità degli elettroni sostanzialmente a "dente di sega", rimandiamo alla seguente nota: \url{https://raw.githubusercontent.com/seggiani-luca/appunti-ed/39b87a5a3719dc4a97dd3596e14ab99535766736/code/python/drude/doc/drude.pdf}.
